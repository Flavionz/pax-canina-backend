...
-- ================================
-- 2. USERS & ROLES (base per tutto)
-- ================================
-- Coach (creatore sessioni)
INSERT INTO user (id_user, last_name, first_name, email, password_hash, phone, registration_date, avatar_url, bio, last_login)
VALUES (2, 'Rossi', 'Mario', 'mario@coach.com', '$2a$12$QKQwiAbwq2OwDmh7AyLOi.JljEkUL8D9OX6OfDttthDG1OQp5nxyi', '3339876543', '2024-04-15', 'https://randomuser.me/api/portraits/men/1.jpg', 'Expert coach', '2024-05-21 09:30:00');
INSERT INTO coach (id_user) VALUES (2);

-- Owner
INSERT INTO user (id_user, last_name, first_name, email, password_hash, phone, registration_date, avatar_url, bio, last_login)
VALUES (11, 'Terenzi', 'Flavio', 'flavio@owner.com', '$2a$10$zvLV1cYKiTd6/4IMH6uXeeYsm6W4D5auN2BPGN0WjI0fRrVRqMbiC', '3331234567', '2024-06-01', 'https://randomuser.me/api/portraits/men/5.jpg', 'Owner Flavio', '2024-06-01 10:00:00');
INSERT INTO owner (id_user, address, city, postal_code)
VALUES (11, 'Via Roma 1', 'Milan', '20100');

-- Admin
INSERT INTO user (id_user, last_name, first_name, email, password_hash, phone, registration_date, avatar_url, bio, last_login)
VALUES (3, 'Admin', 'Master', 'admin@admin.com', '$2a$12$xqlCUYAxHlTKLAB0YMlo4.SY9D59GxE/250F0jnZL1egn9bT0OHyG', '3332223333', '2024-01-01', NULL, 'Super Admin', '2024-05-21 10:30:00');
...
-- ================================
-- 6. SESSIONI (usa coach, course, age_group)
-- ================================
